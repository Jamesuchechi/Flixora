      ...
      <div className="px-10 -mt-12 relative z-20">
        {items.length > 0 ? (
          ...
          <div className="py-20 text-center space-y-4">
             ...
             <p className="text-[10px] font-black uppercase tracking-[4px] text-white/30">The world is taking a break...</p>
             <p className="text-[11px] text-white/20 max-w-xs mx-auto">Trending data is currently updating. Please check back in a few moments.</p>
          </div>
        )}
      </div>
    </div>
