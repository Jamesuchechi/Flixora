...
export async function HeroBanner() {
  ...
  return (
    <div className="relative h-[560px] overflow-hidden">
      ...
      {/* Gradient overlays */}
      <div className="absolute inset-0 bg-gradient-to-r from-[--flx-bg]/95 via-[--flx-bg]/65 to-[--flx-bg]/10" />
      <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-[--flx-bg] to-transparent" />
      ...
      <div className="relative z-10 flex h-full px-12">
        ...
        <div className="flex flex-col justify-center max-w-[520px] pt-4 animate-fade-up">
          ...
          <h1 className="font-['Bebas_Neue',sans-serif] text-[82px] leading-[.9] tracking-[2px] mb-4 text-[--flx-text-1]">
            {title.split(' ').map((word, i) => (
              <span key={i} className={i === Math.floor(title.split(' ').length / 2) ? 'bg-gradient-to-r from-[--flx-cyan] to-[--flx-purple] bg-clip-text text-transparent' : ''}>{word} </span>
            ))}
          </h1>
        ...
        <div className="absolute right-12 top-10 flex gap-3 items-start">
          ...
          <div className="relative w-[200px] h-[300px] rounded-2xl overflow-hidden shadow-[0_0_80px_rgba(139,92,246,0.3),0_30px_80px_rgba(0,0,0,0.9)]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[--flx-purple]/30 to-transparent" />
          </div>
